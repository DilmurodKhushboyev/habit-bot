...
| `callbacks_shop.py` | 218 | Jon sotib olish, referral, ball transfer, reset — 3 tilga. Narxlar `config.py` dan. Helper: `_bozor_back_row(uid)`. Reset `add_points_history(u, -old_points)` chaqiradi (period rating sinxron) |
