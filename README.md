...
> **Checkin kartochka professional dizayni (v442-444)** — emoji 44×44 neumorphic inset doira ichida (havoda suzish muammosi hal), pending checkin tugmasida xira ✓ (CSS `:empty::before` — repeat `1/3` da avtomatik yashirinadi), done holatda yashil gradient + glow, streak 🔥 shartli rang (0=kulrang xira, 1+=jonli turuncha — "boshlamagan vs faol" ajratish), typography ierarxiyasi kuchaytirildi (ism 15px/650, meta opacity 0.85, kartochka margin 10px)
