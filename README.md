...
└── static/                      ← Flask static papka (frontend fayllar)
    ...
    ├── app-profile.js           ← (549 qator) Profil, tahrirlash, til, dark mode, copyRefLink
