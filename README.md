...
super_habits/static/
│
├── index.html               ← (~315 qator) HTML layout, splash, modallar, nav, **FAB**
├── style.css                ← (~3203 qator) neumorphism, dark mode, animatsiyalar, **FAB stillari**
├── strings.js               ← (~1074 qator) UZ/RU/EN tarjimalar, S() funksiya
│
├── ─── JS YADRO ──────────────────────────────────────
├── app-core.js              ← (~598 qator) TG init, API, state, tabs, updateHeaderPts, updateGreeting, **FAB toggle**
│
├── ─── JS SAHIFALAR ──────────────────────────────────
