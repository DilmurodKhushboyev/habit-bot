...
# ── PREMIUM SOZLAMALARI ──
FREE_HABIT_LIMIT     = 3    # Bepul foydalanuvchi uchun odat chegarasi
PREMIUM_HABIT_LIMIT  = 15   # Premium foydalanuvchi uchun odat chegarasi
PREMIUM_PRICE_STARS  = 20   # Telegram Stars/oy
PREMIUM_PRICE_SOM    = 4900 # So'm/oy
PREMIUM_DURATION_DAYS = 30  # Premium muddati (kun)
CLICK_MERCHANT_URL   = os.environ.get("CLICK_MERCHANT_URL", "")   # Click to'lov URL
PAYME_MERCHANT_URL   = os.environ.get("PAYME_MERCHANT_URL", "")   # Payme to'lov URL
...
LANGS = {
    "uz": {
        ...
        "premium_active":    "✅ Premiumingiz faol!\n\n📅 Muddat: *{expires}*",
        "premium_features":  "💎 *Premium afzalliklari:*\n\n✅ Cheksiz odat (15 tagacha)\n✅ Challenge xususiyati\n✅ Batafsil statistika\n✅ Guruh imkoniyatlari\n\n💰 Narx: *{price_som} so'm* yoki *{price_stars} Stars/oy*",
        "premium_buy_btn":   "💎 Premium olish ({price_stars} Stars)",
        "premium_buy_som":   "💳 {price_som} so'm to'lash",
        "premium_bought":    "🎉 *Premium faollashtirildi!*\n\n📅 Muddat: *{expires}*\n\nEndi barcha imkoniyatlardan foydalaning! 💪",
        "free_limit_warn":   "⚠️ *Bepul rejada 3 ta odat bo'ladi.*\n\nKo'proq odat qo'shish uchun Premium oling! 💎",
        "premium_expired":   "⏰ *Premiumingiz muddati tugadi.*\n\nDavom ettirish uchun yangilang! 💎",
        "premium_som_pending": "💳 To'lov amalga oshirilgach, adminga chekni yuboring!\n\n👨‍💼 Admin: @{admin_username}",
        "premium_som_check_sent": "✅ Chek yuborildi! Admin tekshirib, tez orada Premium faollashtiradi.",
        "premium_som_confirmed": "🎉 *Premium faollashtirildi!*\n\n📅 Muddat: *{expires}*\n\nBarcha imkoniyatlardan foydalaning! 💪",
        "premium_som_rejected": "❌ *To'lov tasdiqlanmadi.*\n\nQo'shimcha savollar uchun adminga murojaat qiling.",
        "btn_check_sent": "✅ Chekni yubordim",
    ...
    "en": {
        ...
        "premium_features":  "💎 *Premium benefits:*\n\n✅ Unlimited habits (up to 15)\n✅ Challenge feature\n✅ Detailed statistics\n✅ Group features\n\n💰 Price: *{price_som} UZS* or *{price_stars} Stars/month*",
        "premium_buy_btn":   "💎 Get Premium ({price_stars} Stars)",
        "premium_buy_som":   "💳 Pay {price_som} UZS",
        "premium_bought":    "🎉 *Premium activated!*\n\n📅 Expires: *{expires}*\n\nEnjoy all features! 💪",
        "free_limit_warn":   "⚠️ *Free plan allows 3 habits.*\n\nGet Premium to add more! 💎",
        "premium_expired":   "⏰ *Your Premium has expired.*\n\nRenew to continue! 💎",
        "premium_som_pending": "💳 After payment, send the receipt to admin!\n\n👨‍💼 Admin: @{admin_username}",
        "premium_som_check_sent": "✅ Receipt sent! Admin will verify and activate Premium shortly.",
        "premium_som_confirmed": "🎉 *Premium activated!*\n\n📅 Expires: *{expires}*\n\nEnjoy all features! 💪",
        "premium_som_rejected": "❌ *Payment not confirmed.*\n\nContact admin for more info.",
        "btn_check_sent": "✅ I sent the receipt",
        "btn_got_it": "✅ Got it",
    },
    "ru": {
        ...
        "premium_active":    "✅ Ваш Премиум активен!\n\n📅 Срок: *{expires}*",
        "premium_features":  "💎 *Преимущества Премиум:*\n\n✅ Неограниченные привычки (до 15)\n✅ Функция вызовов\n✅ Подробная статистика\n✅ Функции групп\n\n💰 Цена: *{price_som} сум* или *{price_stars} Stars/мес*",
        "premium_buy_btn":   "💎 Получить Премиум ({price_stars} Stars)",
        "premium_buy_som":   "💳 Оплатить {price_som} сум",
        "premium_bought":    "🎉 *Премиум активирован!*\n\n📅 Срок: *{expires}*\n\nПользуйтесь всеми возможностями! 💪",
        "free_limit_warn":   "⚠️ *Бесплатный план: 3 привычки.*\n\nПолучите Премиум для большего! 💎",
        "premium_expired":   "⏰ *Срок Премиума истёк.*\n\nОбновите для продолжения! 💎",
        "premium_som_pending": "💳 После оплаты отправьте чек администратору!\n\n👨‍💼 Админ: @{admin_username}",
        "premium_som_check_sent": "✅ Чек отправлен! Админ проверит и активирует Premium.",
        "premium_som_confirmed": "🎉 *Премиум активирован!*\n\n📅 Срок: *{expires}*\n\nПользуйтесь всеми возможностями! 💪",
        "premium_som_rejected": "❌ *Оплата не подтверждена.*\n\nСвяжитесь с администратором.",
        "btn_check_sent": "✅ Чек отправил",
        "btn_got_it": "✅ Понятно",
    },
    "tr": {
...
def callback_handler(call):
    ...
    if cdata == "menu_add":
        ...
        _habit_limit = PREMIUM_HABIT_LIMIT if is_premium_user(uid) else FREE_HABIT_LIMIT
        if len(u.get("habits", [])) >= _habit_limit:
            bot.answer_callback_query(call.id)
            if is_premium_user(uid):
                # Premium foydalanuvchi — maksimal limitga yetdi
                sent_limit = bot.send_message(uid, T(uid, "limit"), parse_mode="Markdown")
            else:
                # Bepul foydalanuvchi — Premium taklif qilinadi
                kb_prem = InlineKeyboardMarkup()
                kb_prem.add(cBtn(
                    T(uid, "premium_buy_btn", price_stars=PREMIUM_PRICE_STARS),
                    "menu_premium", "primary"
                ))
                sent_limit = bot.send_message(
                    uid,
                    T(uid, "free_limit_warn"),
                    parse_mode="Markdown",
                    reply_markup=kb_prem
                )
    ...
    if cdata == "menu_premium":
        bot.answer_callback_query(call.id)
        try: bot.delete_message(uid, call.message.message_id)
        except Exception: pass
        _prem_active = is_premium_user(uid)
        if _prem_active:
            _expires = load_user(uid).get("premium_expires", "—")
            text = T(uid, "premium_active", expires=_expires)
        else:
            text = T(uid, "premium_features", price_som=PREMIUM_PRICE_SOM, price_stars=PREMIUM_PRICE_STARS)
        kb_prem = InlineKeyboardMarkup()
        if not _prem_active:
            kb_prem.add(cBtn(
                T(uid, "premium_buy_btn", price_stars=PREMIUM_PRICE_STARS),
                "premium_buy_stars", "primary"
            ))
            kb_prem.add(InlineKeyboardButton(
                T(uid, "premium_buy_som", price_som=PREMIUM_PRICE_SOM),
                callback_data="premium_buy_som"
            ))
        kb_prem.add(cBtn(T(uid, "btn_home"), "menu_main", "primary"))
        sent = bot.send_message(uid, text, parse_mode="Markdown", reply_markup=kb_prem)
        u["main_msg_id"] = sent.message_id
        save_user(uid, u)
        return

    if cdata == "premium_buy_stars":
        bot.answer_callback_query(call.id)
        try:
            from telebot.types import LabeledPrice as _LP2
            bot.send_invoice(
                chat_id=uid,
                title="💎 Super Habits Premium",
                description="30 kunlik premium: cheksiz odat, challenge, statistika",
                invoice_payload="stars_premium",
                provider_token="",
                currency="XTR",
                prices=[_LP2("Premium (30 kun)", PREMIUM_PRICE_STARS)],
            )
        except Exception as _pe:
            print(f"[premium] invoice xatosi: {_pe}")
        return

    if cdata == "premium_buy_som":
        bot.answer_callback_query(call.id)
        try: bot.delete_message(uid, call.message.message_id)
        except Exception: pass
        # Admin username
        settings = load_settings()
        _admin_uname = settings.get("admin_username", "")
        if not _admin_uname:
            try:
                _admin_uname = bot.get_chat(ADMIN_ID).username or str(ADMIN_ID)
            except Exception:
                _admin_uname = str(ADMIN_ID)
        # Foydalanuvchi state = waiting_premium_check: rasm/hujjat yuborishi kutiladi
        u["state"] = "waiting_premium_check"
        save_user(uid, u)
        kb_som = InlineKeyboardMarkup()
        if CLICK_MERCHANT_URL:
            kb_som.add(InlineKeyboardButton("💳 Click orqali to'lash", url=CLICK_MERCHANT_URL))
        if PAYME_MERCHANT_URL:
            kb_som.add(InlineKeyboardButton("💳 Payme orqali to'lash", url=PAYME_MERCHANT_URL))
        kb_som.add(cBtn(T(uid, "btn_check_sent"), f"prem_check_ack_{uid}", "success"))
        kb_som.add(cBtn(T(uid, "btn_home"), "menu_main", "primary"))
        sent = bot.send_message(
            uid,
            T(uid, "premium_som_pending", admin_username=_admin_uname),
            parse_mode="Markdown",
            reply_markup=kb_som
        )
        u["prem_pending_msg_id"] = sent.message_id
        save_user(uid, u)
        return

    # Foydalanuvchi "Chekni yubordim" tugmasini bosdi
    if cdata.startswith("prem_check_ack_"):
        _target_uid = int(cdata[len("prem_check_ack_"):])
        if _target_uid != uid:
            bot.answer_callback_query(call.id)
            return
        bot.answer_callback_query(call.id)
        ...
        # State o'zgartirilmaydi — foydalanuvchi hali chekni yubormagan bo'lishi mumkin.
        # State faqat rasm/hujjat yuborilganda (waiting_premium_check handler) tozalanadi.
        sent_ack = bot.send_message(uid, T(uid, "premium_som_check_sent"))
        def _del_ack(cid, mid):
            time.sleep(5)
            try: bot.delete_message(cid, mid)
            except: pass
        threading.Thread(target=_del_ack, args=(uid, sent_ack.message_id), daemon=True).start()
        return

    # Admin: Premium tasdiqlash
    if cdata.startswith("prem_confirm_") and uid == ADMIN_ID:
        _target_uid = int(cdata[len("prem_confirm_"):])
        bot.answer_callback_query(call.id, "✅ Tasdiqlandi!")
        try: bot.delete_message(uid, call.message.message_id)
        except Exception: pass
        # Premium berish
        ...
        _today_d = date.today()
        _tu = load_user(_target_uid)
        _cur_exp = _tu.get("premium_expires", "")
        try:
            _cur_date = date.fromisoformat(_cur_exp)
            _new_exp = _cur_date + timedelta(days=PREMIUM_DURATION_DAYS) if _cur_date >= _today_d else _today_d + timedelta(days=PREMIUM_DURATION_DAYS)
        except Exception:
            _new_exp = _today_d + timedelta(days=PREMIUM_DURATION_DAYS)
        _tu["is_premium"] = True
        _tu["premium_expires"] = str(_new_exp)
        _tu["state"] = None
        save_user(_target_uid, _tu)
        # Foydalanuvchiga xabar + "✅ Tushunarli" tugmasi (o'chadi)
        kb_conf = InlineKeyboardMarkup()
        kb_conf.add(cBtn(T(_target_uid, "btn_got_it"), f"prem_user_ack_{_target_uid}", "success"))
        try:
            bot.send_message(
                _target_uid,
                T(_target_uid, "premium_som_confirmed", expires=str(_new_exp)),
                parse_mode="Markdown",
                reply_markup=kb_conf
            )
        except Exception as _e:
            print(f"[premium_confirm] send xatosi: {_e}")
        return

    # Admin: Premium rad etish
    if cdata.startswith("prem_reject_") and uid == ADMIN_ID:
        _target_uid = int(cdata[len("prem_reject_"):])
        ...
        save_user(_target_uid, _tu)
        # Foydalanuvchiga xabar + "✅ Tushunarli" tugmasi (o'chadi)
        kb_rej = InlineKeyboardMarkup()
        kb_rej.add(cBtn(T(_target_uid, "btn_got_it"), f"prem_user_ack_{_target_uid}", "primary"))
        try:
            bot.send_message(
                _target_uid,
                T(_target_uid, "premium_som_rejected"),
                parse_mode="Markdown",
                reply_markup=kb_rej
            )
        except Exception as _e:
            print(f"[premium_reject] send xatosi: {_e}")
        return

    # Foydalanuvchi "✅ Tushunarli" (premium tasdiqlash/rad xabarini o'chirish)
    if cdata.startswith("prem_user_ack_"):
        _target_uid = int(cdata[len("prem_user_ack_"):])
        if _target_uid != uid:
            bot.answer_callback_query(call.id)
            return
        bot.answer_callback_query(call.id)
...
def handle_text(msg):
    ...
    # ── Dasturchiga xabar ──
    # ── Premium So'm: chek rasm/hujjat/matn yuborish ──
    if state == "waiting_premium_check":
        user_name = u.get("name", "Noma'lum")
        # Adminga forward + tasdiqlash tugmalari
        _admin_sent = False
        try:
            kb_admin_prem = InlineKeyboardMarkup()
            kb_admin_prem.row(
                cBtn(f"✅ Tasdiqlash — {user_name}", f"prem_confirm_{uid}", "success"),
                cBtn("❌ Rad etish",                  f"prem_reject_{uid}",  "danger")
            )
            admin_caption = (
                f"💳 *Premium to'lov cheki*\n\n"
                f"👤 *{user_name}* (ID: `{uid}`)\n"
                f"💰 {PREMIUM_PRICE_SOM:,} so'm"
            )
            # Rasm, hujjat, video, ovoz yoki matn — barchasini forward qilamiz
            ctype = msg.content_type
            if ctype == "photo":
                bot.send_photo(ADMIN_ID, msg.photo[-1].file_id,
                               caption=admin_caption, parse_mode="Markdown",
                               reply_markup=kb_admin_prem)
            elif ctype == "document":
                ...
                bot.send_message(ADMIN_ID,
                                 admin_caption + f"\n\n📝 Xabar: {text or '(fayl)'}",
                                 parse_mode="Markdown", reply_markup=kb_admin_prem)
            _admin_sent = True
            u["state"] = None
            save_user(uid, u)
        except Exception as _pe:
            print(f"[premium_check] admin xabar xatosi: {_pe}")
        # Foydalanuvchiga: qabul qilindi xabari (5s da o'chadi)
        sent_ok = bot.send_message(uid, T(uid, "premium_som_check_sent"))
        def _del_check_ok(cid, mid):
            time.sleep(5)
            try: bot.delete_message(cid, mid)
            except: pass
        threading.Thread(target=_del_check_ok, args=(uid, sent_ok.message_id), daemon=True).start()
        return
...
def handle_successful_payment(msg):
    ...
    try:
        ...
        # premium_stars — 30 kunlik premium berish
        if item_id == "premium":
            from datetime import date, timedelta
            today_d = date.today()
            # Agar hozir ham premium bo'lsa — muddatiga 30 kun qo'shish
            current_expires = u.get("premium_expires", "")
            try:
                current_date = date.fromisoformat(current_expires)
                if current_date >= today_d:
                    new_expires = current_date + timedelta(days=PREMIUM_DURATION_DAYS)
                else:
                    new_expires = today_d + timedelta(days=PREMIUM_DURATION_DAYS)
            except Exception:
                new_expires = today_d + timedelta(days=PREMIUM_DURATION_DAYS)
            u["is_premium"] = True
            u["premium_expires"] = str(new_expires)
            save_user(uid, u)
            bot.send_message(
                uid,
                T(uid, "premium_bought", expires=str(new_expires)),
                parse_mode="Markdown"
            )
            # Adminga xabar
            try:
                bot.send_message(
                    ...
                    f"👤 {u.get('name','?')} (ID: `{uid}`)\n"
                    f"📅 Muddat: *{new_expires}*\n"
                    f"⭐ {PREMIUM_PRICE_STARS} Stars to'landi",
                    parse_mode="Markdown"
                )
            except Exception:
                pass
...
try:
    ...
    def api_profile(uid):
        ...
        return jsonify({
            ...
            "habit_limit":      PREMIUM_HABIT_LIMIT if is_premium_user(uid) else FREE_HABIT_LIMIT,
            "price_stars":      PREMIUM_PRICE_STARS,
            "price_som":        PREMIUM_PRICE_SOM,
        })
    ...
    def api_habits_add(uid):
        ...
        if time_ != "vaqtsiz" and not _re.match(r"^\d{2}:\d{2}$", time_):
            time_ = "vaqtsiz"
        u = load_user(uid)
        _api_limit = PREMIUM_HABIT_LIMIT if is_premium_user(uid) else FREE_HABIT_LIMIT
        if len(u.get("habits", [])) >= _api_limit:
            return jsonify({"ok": False, "error": "Odatlar soni limitdan oshdi", "limit": _api_limit, "is_premium": is_premium_user(uid)}), 400
        new_habit = {
            "id":           str(uuid.uuid4())[:8],
            "name":         name,
            "icon":         icon,
    ...
    @api_app.route("/api/premium/<int:uid>/buy", methods=["POST"])
    @require_auth
    def api_premium_buy(uid):
        """Stars yoki So'm orqali Premium sotib olish."""
        data = request.get_json(force=True, silent=True) or {}
        pay_type = data.get("type", "stars")  # "stars" | "som"
        ...
        if pay_type == "stars":
            try:
                ...
                bot.send_invoice(
                    ...
                    provider_token="",
                    currency="XTR",
                    prices=[_LP("Premium (30 kun)", PREMIUM_PRICE_STARS)],
                )
                return jsonify({"ok": True, "type": "stars"})
            except Exception as e:
                return jsonify({"ok": False, "error": str(e)}), 500

        elif pay_type == "som":
            # So'm to'lovi: Click/Payme URL qaytariladi + adminga xabar
            settings = load_settings()
            _admin_uname = settings.get("admin_username", "")
            if not _admin_uname:
                try:
            ...
            u = load_user(uid)
            # Foydalanuvchi state = waiting_premium_check: rasm/hujjat yuborishi kutiladi
            # (bot callback handler bilan sinxron — u yerda ham xuddi shu state o'rnatiladi)
            u["state"] = "waiting_premium_check"
            save_user(uid, u)
            # Adminga pending xabari
            try:
                bot.send_message(
                    ADMIN_ID,
                    f"💳 *So'm to'lovi so'rovi!*\n\n"
                    f"👤 {u.get('name','?')} (ID: `{uid}`)\n"
                    f"💰 {PREMIUM_PRICE_SOM:,} so'm premium so'radi",
                    parse_mode="Markdown"
                )
            except Exception:
                pass
            return jsonify({
                "ok": True,
                "type": "som",
                "click_url": CLICK_MERCHANT_URL,
                "payme_url": PAYME_MERCHANT_URL,
                "price_som": PREMIUM_PRICE_SOM,
                "admin_username": _admin_uname,
                "bot_username": get_bot_username(),
            })

        return jsonify({"ok": False, "error": "Noma'lum to'lov turi"}), 400

    @api_app.route("/api/premium/<int:uid>/status", methods=["GET"])
    @require_auth
    def api_premium_status(uid):
        """Foydalanuvchining premium holatini qaytaradi."""
        active = is_premium_user(uid)
        u = load_user(uid)
        return jsonify({
            "is_premium": active,
            "premium_expires": u.get("premium_expires", ""),
            "price_stars": PREMIUM_PRICE_STARS,
            "price_som": PREMIUM_PRICE_SOM,
            "free_limit": FREE_HABIT_LIMIT,
            "premium_limit": PREMIUM_HABIT_LIMIT,
        })
