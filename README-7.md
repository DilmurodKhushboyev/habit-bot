...
| `texts.py` | ~301 | `LANGS` dict — uz/en/ru (3 til). `btn_ack` — xabarni o'chirish tugmasi. Faqat data, funksiyalar yo'q (hammasi helpers.py da) |
| `motivation.py` | 105 | `MOTIVATSIYA` dict — uz/en/ru motivatsion gaplar (30 ta, prefikssiz) |
