...
languages.py
============
Ko'p til (uz, en, ru, tr, kk, tg, tk, ky, de, fr) va motivatsiya matnlari.
Bu faylda: LANGS, MOTIVATSIYA lug'atlari va T(), get_lang(), get_rank() funksiyalari.
Bog'liq fayllar: database.py, config.py
"""
