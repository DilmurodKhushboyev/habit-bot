...
function renderStats(d) {
  ...
  const sumHtml = `
    <div class="summary-grid">
      ...
      <div class="sum-card sum-card-anim" style="color:#10B981">
        <div style="display:flex;justify-content:space-between;align-items:flex-start;width:100%">
          <span class="sum-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"><defs><linearGradient id="siFire" x1="0" y1="24" x2="24" y2="0"><stop offset="0%" stop-color="#059669"/><stop offset="100%" stop-color="#10B981"/></linearGradient></defs><path d="M12 23c-4.97 0-8-3.58-8-7.5 0-3.07 2.17-5.77 4.5-7.5.5-.37 1.2.1 1.05.7-.42 1.64.22 3.16 1.45 3.8.36.19.8-.04.84-.44.52-4.78 3.66-7.56 4.66-8.06.47-.23 1.02.17.9.68-.58 2.44.52 4.82 2.6 5.82.36.17.57.54.57.93 0 2.87-.5 5.07-2.07 7.07C16.5 21 14.5 23 12 23z" fill="url(#siFire)"/></svg></span>
          <svg width="46" height="46" viewBox="0 0 46 46">
            ...
            <defs><linearGradient id="gStrk" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs>
            <text x="23" y="27" text-anchor="middle" font-size="11" font-weight="900" fill="#059669" font-family="DM Mono,monospace">${streakPct}%</text>
          </svg>
        </div>
        <div class="sum-val" style="color:#059669">${summary.streak}</div>
        <div class="sum-lbl">${S('stats','streak_label')}</div>
        <div class="sum-progress">
          <div class="sum-bar-fill" style="height:100%;width:${streakPct}%;background:linear-gradient(90deg,#34D399,#059669);border-radius:3px"></div>
        </div>
        <div class="sum-record"><svg width="10" height="10" viewBox="0 0 24 24" fill="none"><path d="M12 2l3 7h7l-5.5 4.5 2 7L12 16l-6.5 4.5 2-7L2 9h7z" fill="#059669"/></svg>record: ${bestStreak}</div>
      </div>

      <!-- 2. BALL — animated donut -->
      <div class="sum-card sum-card-anim" style="color:#D4963A">
        <div style="display:flex;justify-content:space-between;align-items:flex-start;width:100%">
          <span class="sum-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"><defs><linearGradient id="siStar" x1="0" y1="24" x2="24" y2="0"><stop offset="0%" stop-color="#D4963A"/><stop offset="100%" stop-color="#FBBF24"/></linearGradient></defs><path d="M12 2l2.94 6.34L22 9.27l-5.04 4.63L18.18 21 12 17.27 5.82 21l1.22-7.1L2 9.27l7.06-.93L12 2z" fill="url(#siStar)"/></svg></span>
          <svg width="46" height="46" viewBox="0 0 46 46">
            <circle cx="23" cy="23" r="18" fill="none" stroke="var(--bg)" stroke-width="5" opacity=".5"/>
            <circle cx="23" cy="23" r="18" fill="none" stroke="url(#gBall2)" stroke-width="5"
              ...
              stroke-dashoffset="${(2*Math.PI*18*0.25).toFixed(1)}" stroke-linecap="round" class="sum-ring"/>
            <defs><linearGradient id="gBall2" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#FBBF24"/><stop offset="100%" stop-color="#D4963A"/></linearGradient></defs>
      ...
      <div class="sum-card sum-card-anim" style="color:#10B981">
        <div style="display:flex;justify-content:space-between;align-items:flex-start;width:100%">
          <span class="sum-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"><defs><linearGradient id="siCheck" x1="0" y1="24" x2="24" y2="0"><stop offset="0%" stop-color="#059669"/><stop offset="100%" stop-color="#34D399"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#siCheck)" opacity=".18"/><circle cx="12" cy="12" r="10" stroke="url(#siCheck)" stroke-width="2" fill="none"/><path d="M8 12.5l2.5 3 5.5-6" stroke="url(#siCheck)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span>
          <svg width="46" height="46" viewBox="0 0 46 46">
            <circle cx="23" cy="23" r="18" fill="none" stroke="var(--bg)" stroke-width="5" opacity=".5"/>
            <circle cx="23" cy="23" r="18" fill="none" stroke="url(#gAct)" stroke-width="5"
              ...
              stroke-dashoffset="${(2*Math.PI*18*0.25).toFixed(1)}" stroke-linecap="round" class="sum-ring"/>
            <defs><linearGradient id="gAct" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs>
            <text x="23" y="27" text-anchor="middle" font-size="11" font-weight="900" fill="#059669" font-family="DM Mono,monospace">${Math.round(summary.active_days_30/30*100)}%</text>
          </svg>
        </div>
        <div class="sum-val" style="color:#059669">${summary.active_days_30}</div>
        <div class="sum-lbl">${S('stats','faol_kun')}</div>
        <div class="sum-progress">
          <div class="sum-bar-fill" style="height:100%;width:${Math.round(summary.active_days_30/30*100)}%;background:linear-gradient(90deg,#34D399,#059669);border-radius:3px"></div>
        </div>
        <div class="sum-record"><svg width="10" height="10" viewBox="0 0 24 24" fill="none"><rect x="3" y="5" width="18" height="16" rx="3" stroke="#059669" stroke-width="2" fill="none"/><path d="M3 10h18" stroke="#059669" stroke-width="2"/></svg>${summary.active_days_30}/30</div>
      </div>

      <!-- 4. ODAT — animated ring + count -->
      <div class="sum-card sum-card-anim" style="color:#059669">
        <div style="display:flex;justify-content:space-between;align-items:flex-start;width:100%">
          <span class="sum-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none"><defs><linearGradient id="siClip" x1="0" y1="24" x2="24" y2="0"><stop offset="0%" stop-color="#059669"/><stop offset="100%" stop-color="#10B981"/></linearGradient></defs><rect x="5" y="4" width="14" height="17" rx="2.5" stroke="url(#siClip)" stroke-width="2"/><rect x="8" y="2" width="8" height="4" rx="1.5" fill="url(#siClip)"/><path d="M8 11h8M8 14.5h5" stroke="url(#siClip)" stroke-width="2" stroke-linecap="round"/></svg></span>
          <svg width="46" height="46" viewBox="0 0 46 46">
            <circle cx="23" cy="23" r="18" fill="none" stroke="var(--bg)" stroke-width="5" opacity=".5"/>
            <circle cx="23" cy="23" r="18" fill="none" stroke="url(#gHab)" stroke-width="5"
              ...
              stroke-dashoffset="${(2*Math.PI*18*0.25).toFixed(1)}" stroke-linecap="round" class="sum-ring"/>
            <defs><linearGradient id="gHab" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#10B981"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs>
            <text x="23" y="27" text-anchor="middle" font-size="11" font-weight="900" fill="#059669" font-family="DM Mono,monospace">${Math.round(summary.total_habits/15*100)}%</text>
          </svg>
        </div>
        <div class="sum-val" style="color:#059669">${summary.total_habits}</div>
        <div class="sum-lbl">${S('stats','habits_label')}</div>
        <div class="sum-record"><svg width="10" height="10" viewBox="0 0 24 24" fill="none"><path d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2" stroke="#059669" stroke-width="2" fill="none"/><rect x="9" y="3" width="6" height="4" rx="1" stroke="#059669" stroke-width="2" fill="none"/></svg>${S('stats','total_label')}: ${summary.total_habits}/15</div>
      </div>
  ...
  const barsHtml = weekly.map((w, i) => {
    ...
    const color = pct >= 80 ? '#10B981' : pct >= 40 ? '#059669' : pct > 0 ? '#F59E0B' : '#B4BDB8';
  ...
  const areaChartHtml = (() => {
    ...
    const dotColor = lastPct >= 80 ? '#10B981' : lastPct >= 40 ? '#059669' : '#F59E0B';
    return '<div class="bar-chart" style="padding-bottom:18px">'
      ...
      + '<defs><linearGradient id="areaFill30" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="#10B981" stop-opacity="0.3"/><stop offset="100%" stop-color="#10B981" stop-opacity="0.02"/></linearGradient>'
      + '<linearGradient id="lineG30" x1="0" y1="0" x2="1" y2="0"><stop offset="0%" stop-color="#059669"/><stop offset="100%" stop-color="#10B981"/></linearGradient></defs>'
      + gridLines
  ...
  if (trend) {
    ...
    const aColor= dir === 'up'   ? '#10B981' : dir === 'down' ? '#F59E0B' : '#6B8C80';
        ...
        <div style="display:flex;align-items:flex-end;gap:16px">
          <div style="flex:1">
            ...
            <div style="height:8px;border-radius:4px;background:var(--bg);box-shadow:var(--sh-in);overflow:hidden">
              <div style="height:100%;border-radius:4px;background:#B4BDB8;width:${Math.round(barPrev/barMax*100)}%;transition:width .5s"></div>
            </div>
  ...
  (habit_stats || []).forEach((h, hIdx) => {
    const pctColor = h.percent >= 80 ? '#10B981' : h.percent >= 50 ? '#059669' : '#F59E0B';
    ...
    const donutSvg = `<svg width="56" height="56" viewBox="0 0 56 56">
      <circle cx="28" cy="28" r="${r}" fill="none" stroke="#B4BDB8" stroke-width="5"/>
      ...
      <div class="hstat-card">
        <div class="hstat-top">
          ...
          <div class="hstat-info">
            ...
            <div class="hstat-sub"><svg width="13" height="13" viewBox="0 0 20 20" fill="none" style="display:inline;vertical-align:middle"><defs><linearGradient id="svgFire${hIdx}" x1="10" y1="0" x2="10" y2="20" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M10 2C10 2 14 6 14 10C14 12 13 13.5 11.5 14.5C12 13 11.5 11.5 10.5 11C11 13 9.5 15 8 15.5C9 14 8.5 12 7 11C5.5 12.5 6 15 7 16.5C5.5 15.5 4 13.5 4 11C4 7 8 4 10 2Z" fill="url(#svgFire${hIdx})"/></svg> ${h.streak} ${S('today','days_streak')} streak</div>
          </div>
        </div>
        ...
        ${(() => {
          ...
          const c66 = d66 >= 66 ? '#10B981' : d66 >= 33 ? '#059669' : '#F59E0B';
  ...
  document.getElementById('stats-content').innerHTML = `
    ...
    <button type="button" onclick="generateShareCard()" id="share-card-btn"
      style="width:100%;padding:14px 16px;border:none;border-radius:16px;cursor:pointer;
        ...
        margin-bottom:8px;box-shadow:0 4px 12px #10B98133">
...
async function generateShareCard() {
  ...
  try {
    ...
    const P = isDark ? {
      bg1:'#1A2E28', bg2:'#152420', surface:'#213D34', raised:'#264539',
      text:'#E8F2EE', sub:'#6B8C80', sub2:'#4A6B60',
      shDark:'#0F1C17', shLight:'#233E35',
    } : {
      bg1:'#E4EBE8', bg2:'#DAE2DF', surface:'#ECF2EF', raised:'#F0F5F3',
      text:'#1E3A2F', sub:'#6B8C80', sub2:'#9AB3A8',
      shDark:'#B4BDB8', shLight:'#FFFFFF',
    };
    const accent='#10B981', accent2='#059669', green='#10B981', gold='#D4963A', purple='#34D399';
    ...
    const diffClr=dir==='up'?green:dir==='down'?'#EF4444':accent2;
...
function renderRating(d) {
  ...
  podiumOrder.forEach(idx => {
    ...
    podiumHtml += `
      <div style="flex:1;max-width:110px;text-align:center">
        ...
        <div style="font-size:${idx===0?'13px':'11px'};font-weight:700;color:${isMe?'#10B981':'var(--text)'};margin-bottom:2px">${u.name.split(' ')[0]}</div>
        ${u.badge ? `<div style="font-size:10px">${u.badge}</div>` : ''}
        <div style="font-size:10px;color:${col};font-weight:700;margin-bottom:6px">
          ${sort_by==='points'?u.points+' ⭐':sort_by==='streak'?u.streak+'&nbsp;' + `<svg width="13" height="13" viewBox="0 0 20 20" fill="none" style="display:inline;vertical-align:middle"><defs><linearGradient id="svgFireX" x1="10" y1="0" x2="10" y2="20" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M10 2C10 2 14 6 14 10C14 12 13 13.5 11.5 14.5C12 13 11.5 11.5 10.5 11C11 13 9.5 15 8 15.5C9 14 8.5 12 7 11C5.5 12.5 6 15 7 16.5C5.5 15.5 4 13.5 4 11C4 7 8 4 10 2Z" fill="url(#svgFireX)"/></svg>`:u.score+' '+S('profile','kun')}
        </div>
  ...
  users.slice(3).forEach((u, i) => {
    ...
    const pct    = calcPct(u);
    const isMe   = u.is_me;
    const subLbl = sort_by==='points'?u.points+' ⭐':sort_by==='streak'?u.streak+'&nbsp;' + `<svg width="13" height="13" viewBox="0 0 20 20" fill="none" style="display:inline;vertical-align:middle"><defs><linearGradient id="svgFireX" x1="10" y1="0" x2="10" y2="20" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M10 2C10 2 14 6 14 10C14 12 13 13.5 11.5 14.5C12 13 11.5 11.5 10.5 11C11 13 9.5 15 8 15.5C9 14 8.5 12 7 11C5.5 12.5 6 15 7 16.5C5.5 15.5 4 13.5 4 11C4 7 8 4 10 2Z" fill="url(#svgFireX)"/></svg>`:u.score+' '+S('profile','kun');
    rowsHtml += `
      <div style="display:flex;align-items:center;gap:10px;padding:10px 14px;
        border-radius:14px;margin-bottom:4px;background:var(--bg);
        box-shadow:${isMe?'0 0 0 2px #10B981':'var(--sh-sm)'}">
        ...
        <div style="flex:1;min-width:0">
          <div style="display:flex;align-items:center;gap:5px">
            <div style="font-size:13px;font-weight:700;color:${isMe?'#10B981':'var(--text)'};white-space:nowrap;overflow:hidden;text-overflow:ellipsis;flex:1">${u.name}${u.badge?' '+u.badge:''}</div>
            ${u.habits_count ? `<div style="flex-shrink:0;font-size:9px;font-weight:700;color:#10B981;background:#10B98118;border-radius:6px;padding:2px 5px;white-space:nowrap"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle"><defs><linearGradient id=\"svgClipRat\" x1=\"0\" y1=\"0\" x2=\"24\" y2=\"24\" gradientUnits=\"userSpaceOnUse\"><stop offset=\"0%\" stop-color=\"#10B981\"/><stop offset=\"100%\" stop-color=\"#059669\"/></linearGradient></defs><rect x=\"8\" y=\"2\" width=\"8\" height=\"4\" rx=\"1\" fill=\"url(#svgClipRat)\"/><rect x=\"4\" y=\"4\" width=\"16\" height=\"18\" rx=\"2\" fill=\"url(#svgClipRat)\" opacity=\"0.15\"/><rect x=\"4\" y=\"4\" width=\"16\" height=\"18\" rx=\"2\" stroke=\"url(#svgClipRat)\" stroke-width=\"1.5\"/><path d=\"M8 11h8M8 15h5\" stroke=\"url(#svgClipRat)\" stroke-width=\"1.5\" stroke-linecap=\"round\"/></svg> ${u.habits_count}</div>` : ''}
            ${u.active_items ? `<div style="flex-shrink:0;font-size:11px;white-space:nowrap;background:#34D39918;border-radius:6px;padding:2px 5px">${u.active_items}</div>` : ''}
          ...
          <div style="height:4px;border-radius:2px;background:var(--bg);box-shadow:var(--sh-in);margin-top:5px;overflow:hidden">
            <div style="height:100%;border-radius:2px;background:#059669;width:${pct}%;transition:width .4s"></div>
          </div>
        </div>
  ...
  if (caller_entry) {
    ...
    const pct = calcPct(u);
    const sub = sort_by==='points'?u.points+' ⭐':sort_by==='streak'?u.streak+'&nbsp;' + `<svg width="13" height="13" viewBox="0 0 20 20" fill="none" style="display:inline;vertical-align:middle"><defs><linearGradient id="svgFireX" x1="10" y1="0" x2="10" y2="20" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M10 2C10 2 14 6 14 10C14 12 13 13.5 11.5 14.5C12 13 11.5 11.5 10.5 11C11 13 9.5 15 8 15.5C9 14 8.5 12 7 11C5.5 12.5 6 15 7 16.5C5.5 15.5 4 13.5 4 11C4 7 8 4 10 2Z" fill="url(#svgFireX)"/></svg>`:u.score+' '+S('profile','kun');
    myRowHtml = `
      <div style="margin-top:4px;border-top:1px solid var(--bg);padding-top:8px">
        ...
        <div style="display:flex;align-items:center;gap:10px;padding:10px 14px;
          border-radius:14px;background:var(--bg);box-shadow:0 0 0 2px #059669">
          <div style="width:24px;height:24px;border-radius:50%;background:linear-gradient(135deg,#059669,#10B981);display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 0 0 2px #05966944"><span style="font-size:10px;font-weight:800;color:#fff">${u.rank}</span></div>
          ${userAvatarHTML(u, 34)}
          <div style="flex:1;min-width:0">
            <div style="display:flex;align-items:center;gap:5px">
              <div style="font-size:13px;font-weight:700;color:#059669;flex:1">${u.name}</div>
              ${u.habits_count ? `<div style="flex-shrink:0;font-size:9px;font-weight:700;color:#10B981;background:#10B98118;border-radius:6px;padding:2px 5px;white-space:nowrap"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle"><defs><linearGradient id=\"svgClipRat\" x1=\"0\" y1=\"0\" x2=\"24\" y2=\"24\" gradientUnits=\"userSpaceOnUse\"><stop offset=\"0%\" stop-color=\"#10B981\"/><stop offset=\"100%\" stop-color=\"#059669\"/></linearGradient></defs><rect x=\"8\" y=\"2\" width=\"8\" height=\"4\" rx=\"1\" fill=\"url(#svgClipRat)\"/><rect x=\"4\" y=\"4\" width=\"16\" height=\"18\" rx=\"2\" fill=\"url(#svgClipRat)\" opacity=\"0.15\"/><rect x=\"4\" y=\"4\" width=\"16\" height=\"18\" rx=\"2\" stroke=\"url(#svgClipRat)\" stroke-width=\"1.5\"/><path d=\"M8 11h8M8 15h5\" stroke=\"url(#svgClipRat)\" stroke-width=\"1.5\" stroke-linecap=\"round\"/></svg> ${u.habits_count}</div>` : ''}
              ${u.active_items ? `<div style="flex-shrink:0;font-size:11px;white-space:nowrap;background:#34D39918;border-radius:6px;padding:2px 5px">${u.active_items}</div>` : ''}
              ${(j=>{const e=j>=80?"❤️":j>=50?"🧡":j>=20?"💛":"🖤";return `<div style="flex-shrink:0;font-size:9px;font-weight:700;color:var(--sub);background:var(--bg);box-shadow:var(--sh-in);border-radius:6px;padding:2px 5px;white-space:nowrap">${e} ${j}%</div>`;})(u.jon??100)}
            </div>
            <div style="height:4px;border-radius:2px;background:var(--bg);box-shadow:var(--sh-in);margin-top:5px;overflow:hidden">
              <div style="height:100%;border-radius:2px;background:#059669;width:${pct}%"></div>
            </div>
          </div>
          <div style="font-size:12px;font-weight:700;color:#059669">${sub}</div>
        </div>
      </div>`;
  }

  // ── Sort va Period switch ──
  const sorts   = [['points',S('rating','sort_points')],['streak','<svg width="14" height="14" viewBox="0 0 20 20" fill="none" style="display:inline;vertical-align:middle;margin-right:4px"><defs><linearGradient id="gPFire" x1="0" y1="0" x2="20" y2="20" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M10 2C10 2 14 6 14 10C14 12 13 13.5 11.5 14.5C12 13 11.5 11.5 10.5 11C11 13 9.5 15 8 15.5C9 14 8.5 12 7 11C5.5 12.5 6 15 7 16.5C5.5 15.5 4 13.5 4 11C4 7 8 4 10 2Z" fill="url(#gPFire)"/></svg>'+S('rating','sort_streak')],['active','<svg width="14" height="14" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle;margin-right:4px"><defs><linearGradient id="gPCal" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#059669"/><stop offset="100%" stop-color="#10B981"/></linearGradient></defs><rect x="3" y="5" width="18" height="16" rx="3" stroke="url(#gPCal)" stroke-width="2"/><path d="M3 10h18M8 3v4M16 3v4" stroke="url(#gPCal)" stroke-width="2" stroke-linecap="round"/></svg>'+S('rating','sort_active')]];
