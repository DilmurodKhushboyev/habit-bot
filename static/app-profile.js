...
function renderProfile(d) {
  data.profile = d;
  const jon = d.jon ?? 100;
  const jonColor = jon >= 70 ? '#10B981' : jon >= 40 ? '#D4963A' : '#EF4444';
  ...
  const vipBadge = d.is_vip
    ? '<span style="background:#05966922;color:#059669;border-radius:8px;padding:2px 8px;font-size:11px;font-weight:700;margin-left:6px"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle;margin-right:3px"><defs><linearGradient id="svgVip" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#059669"/><stop offset="100%" stop-color="#34D399"/></linearGradient></defs><path d="M12 2l1.8 5.5H20l-4.9 3.6 1.8 5.5L12 13l-4.9 3.6 1.8-5.5L4 7.5h6.2z" fill="url(#svgVip)"/></svg> VIP</span>'
    : '';

  // Premium badge
  const premiumBadge = d.is_premium
    ? `<span onclick="showPremiumPage()" style="cursor:pointer;background:linear-gradient(90deg,#FBBF2422,#D4963A22);color:#C4983A;border-radius:8px;padding:2px 10px;font-size:11px;font-weight:700;margin-left:6px;border:1px solid #FBBF2444">💎 Premium</span>`
  ...
  const achColor = achPct >= 80 ? '#10B981' : achPct >= 40 ? '#059669' : '#059669';
  ...
  document.getElementById('profile-content').innerHTML = `
    ...
    <div class="profile-card">
      <div class="profile-top">
        ...
        <div style="flex:1;min-width:0">
          ...
          <div style="font-size:11px;color:var(--sub);margin-top:2px"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle;margin-right:3px"><defs><linearGradient id="gTrophy" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M8 21h8M12 17v4M5 3h14v8a7 7 0 01-14 0V3z" stroke="url(#gTrophy)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><path d="M5 6H2v3a3 3 0 003 3M19 6h3v3a3 3 0 01-3 3" stroke="url(#gTrophy)" stroke-width="2" stroke-linecap="round" fill="none"/></svg>${rankTxt} ${S('msg','rank_position')}</div>
          <div style="font-size:10px;color:var(--sub);margin-top:2px"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle;margin-right:3px"><defs><linearGradient id="gCalSm" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#059669"/><stop offset="100%" stop-color="#10B981"/></linearGradient></defs><rect x="3" y="5" width="18" height="16" rx="3" stroke="url(#gCalSm)" stroke-width="2"/><path d="M3 10h18M8 3v4M16 3v4" stroke="url(#gCalSm)" stroke-width="2" stroke-linecap="round"/></svg>${joinedStr} ${S('msg','since_date')}</div>
        </div>
      ...
      <div style="display:flex;gap:6px;flex-wrap:wrap;margin-top:10px">
        ...
        ${d.streak_shields > 0 ? `<div style="display:flex;align-items:center;gap:4px;background:var(--bg);border-radius:20px;padding:4px 10px;box-shadow:var(--sh-sm);font-size:12px"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle;margin-right:4px"><defs><linearGradient id="svgShield" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#059669"/><stop offset="100%" stop-color="#34D399"/></linearGradient></defs><path d="M12 3L4 7v5c0 5 4 9 8 10 4-1 8-5 8-10V7L12 3z" fill="url(#svgShield)" opacity="0.85"/></svg><span style="color:var(--sub)">${d.streak_shields}x ${S('profile','shield_badge')}</span></div>` : ''}
        ${d.bonus_2x_active ? `<div style="display:flex;align-items:center;gap:4px;background:var(--bg);border-radius:20px;padding:4px 10px;box-shadow:var(--sh-sm);font-size:12px"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle;margin-right:4px"><defs><linearGradient id="svgBolt" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M13 2L4 14h7l-1 8 9-12h-7l1-8z" fill="url(#svgBolt)"/></svg><span style="color:#059669;font-weight:700">2× bonus</span></div>` : ''}
        ${d.bonus_3x_active ? `<div style="display:flex;align-items:center;gap:4px;background:var(--bg);border-radius:20px;padding:4px 10px;box-shadow:var(--sh-sm);font-size:12px"><svg width="15" height="15" viewBox="0 0 20 20" fill="none" style="display:inline;vertical-align:middle;margin-right:4px"><defs><linearGradient id="svgFireB" x1="10" y1="0" x2="10" y2="20" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M10 2C10 2 14 6 14 10C14 12 13 13.5 11.5 14.5C12 13 11.5 11.5 10.5 11C11 13 9.5 15 8 15.5C9 14 8.5 12 7 11C5.5 12.5 6 15 7 16.5C5.5 15.5 4 13.5 4 11C4 7 8 4 10 2Z" fill="url(#svgFireB)"/></svg><span style="color:#059669;font-weight:700">3× bonus</span></div>` : ''}
        ${d.xp_booster_days > 0 ? `<div style="display:flex;align-items:center;gap:4px;background:var(--bg);border-radius:20px;padding:4px 10px;box-shadow:var(--sh-sm);font-size:12px"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle;margin-right:4px"><defs><linearGradient id="svgDiamond" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#059669"/><stop offset="100%" stop-color="#34D399"/></linearGradient></defs><path d="M6 3h12l4 6-10 12L2 9z" fill="url(#svgDiamond)" opacity="0.85"/></svg><span style="color:#059669;font-weight:700">💎 ${d.xp_booster_days} ${S('profile','kun')}</span></div>` : ''}
      </div>` : ''}
      ...
      <div style="display:flex;justify-content:space-between;align-items:center;margin-top:14px;margin-bottom:6px">
        <span style="font-size:12px;font-weight:700;color:var(--sub)"><svg width="14" height="14" viewBox="0 0 20 20" fill="none" style="display:inline;vertical-align:middle;margin-right:2px"><defs><linearGradient id="svgHeart" x1="0" y1="0" x2="20" y2="20" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#FF6B8A"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M10 17C10 17 2 12 2 6.5A4.5 4.5 0 0110 4a4.5 4.5 0 018 2.5C18 12 10 17 10 17z" fill="url(#svgHeart)"/></svg> JON</span>
    ...
    <!-- Do'st taklif qilish -->
    <div class="section-title"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle;margin-right:5px"><defs><linearGradient id="svgRefH" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#10B981"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2" stroke="url(#svgRefH)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"/><circle cx="9" cy="7" r="4" stroke="url(#svgRefH)" stroke-width="2" fill="none"/><path d="M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75" stroke="url(#svgRefH)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> ${S('msg','ref_title')}</div>
    <div class="rem-card" style="margin-bottom:8px">
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
        <div>
          <div style="font-size:13px;font-weight:700;color:var(--text)"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle;margin-right:4px"><defs><linearGradient id="svgRefPpl" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#10B981"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><circle cx="9" cy="7" r="3.5" fill="url(#svgRefPpl)" opacity="0.85"/><circle cx="16.5" cy="7.5" r="2.8" fill="url(#svgRefPpl)" opacity="0.6"/><path d="M1.5 20c0-3.5 3-6.5 7.5-6.5s7.5 3 7.5 6.5" stroke="url(#svgRefPpl)" stroke-width="2" stroke-linecap="round" fill="none"/><path d="M17 14c2.5.5 5 2.5 5 5" stroke="url(#svgRefPpl)" stroke-width="1.8" stroke-linecap="round" fill="none" opacity="0.6"/></svg>${S('msg','ref_count').replace('{n}', d.ref_count || 0)}</div>
      ...
      ${(function() {
        var svgShield = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle"><defs><linearGradient id="svgMsS" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#059669"/><stop offset="100%" stop-color="#34D399"/></linearGradient></defs><path d="M12 3L4 7v5c0 5 4 9 8 10 4-1 8-5 8-10V7L12 3z" fill="url(#svgMsS)" opacity="0.9"/></svg>';
        var svgStar   = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle"><defs><linearGradient id="svgMsT" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M12 2l2.4 7.4H22l-6.2 4.5 2.4 7.4L12 17l-6.2 4.3 2.4-7.4L2 9.4h7.6z" fill="url(#svgMsT)"/></svg>';
        var svgVip    = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle"><defs><linearGradient id="svgMsV" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#059669"/><stop offset="100%" stop-color="#34D399"/></linearGradient></defs><path d="M6 3h12l4 6-10 12L2 9z" fill="url(#svgMsV)" opacity="0.9"/></svg>';
        var svgDone   = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle"><defs><linearGradient id="svgMsD" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#10B981"/><stop offset="100%" stop-color="#047857"/></linearGradient></defs><circle cx="12" cy="12" r="9" fill="url(#svgMsD)" opacity="0.15"/><path d="M7 12l4 4 6-7" stroke="url(#svgMsD)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>';
        var svgEmpty  = '<svg width="14" height="14" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle"><circle cx="12" cy="12" r="9" stroke="#B4BDB8" stroke-width="2"/></svg>';
        var milestones = [
        ...
        var nextTxt = next
          ? '<div style="font-size:11px;color:var(--accent);margin-top:6px"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle;margin-right:3px"><defs><linearGradient id="svgHglass" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M6 2h12M6 22h12M7 2v4c0 2.5 2 4.5 5 6-3 1.5-5 3.5-5 6v4M17 2v4c0 2.5-2 4.5-5 6 3 1.5 5 3.5 5 6v4" stroke="url(#svgHglass)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M9.5 16.5c0-1.5 1.2-2.5 2.5-3.2 1.3.7 2.5 1.7 2.5 3.2v3.5h-5v-3.5z" fill="url(#svgHglass)" opacity="0.4"/></svg>' + S('msg','ref_next').replace('{n}', (next.n - rc)) + '</div>'
      ...
      <button id="copy-ref-btn" data-link="${(d.ref_link || '').replace(/"/g, '&quot;')}" type="button"
        style="width:100%;padding:11px;border:none;border-radius:12px;background:linear-gradient(135deg,#10B981,#059669);color:#fff;font-size:13px;font-weight:700;cursor:pointer">
    ...
    <!-- Sozlamalar -->
    <div class="section-title"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle;margin-right:5px"><defs><linearGradient id="svgGear" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#6B8C80"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><circle cx="12" cy="12" r="3.5" stroke="url(#svgGear)" stroke-width="2"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3M4.93 4.93l2.12 2.12M16.95 16.95l2.12 2.12M4.93 19.07l2.12-2.12M16.95 7.05l2.12-2.12" stroke="url(#svgGear)" stroke-width="2" stroke-linecap="round"/></svg> ${S('profile','settings')}</div>
    <div style="margin-bottom:8px">
      <div class="rem-card" style="cursor:pointer" onclick="openEditProfile()">
        <div class="rem-top" style="margin-bottom:0">
          <div class="rem-icon"><svg width="22" height="22" viewBox="0 0 26 26" fill="none"><defs><linearGradient id="svgPenLg" x1="0" y1="0" x2="26" y2="26" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M17 4L22 9L10 21L4 22L5 16L17 4Z" fill="url(#svgPenLg)" opacity="0.85"/><path d="M15 6L20 11" stroke="white" stroke-width="1.2" stroke-linecap="round" opacity="0.6"/></svg></div><div class="rem-name" style="font-size:12px">${S('profile','edit_profile')}</div>
    ...
    <div class="rem-card" style="margin-top:4px;cursor:pointer" onclick="openLangModal()">
      <div class="rem-top" style="margin-bottom:0">
        <div class="rem-icon"><svg width="22" height="22" viewBox="0 0 26 26" fill="none"><defs><linearGradient id="svgGlobLg" x1="0" y1="0" x2="26" y2="26" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#059669"/><stop offset="100%" stop-color="#10B981"/></linearGradient></defs><circle cx="13" cy="13" r="10" stroke="url(#svgGlobLg)" stroke-width="2"/><ellipse cx="13" cy="13" rx="4.5" ry="10" stroke="url(#svgGlobLg)" stroke-width="1.5"/><path d="M3 13h20M3 9h20M3 17h20" stroke="url(#svgGlobLg)" stroke-width="1.2" opacity="0.5"/></svg></div>
    ...
    <div class="rem-card" style="margin-top:4px;cursor:pointer" onclick="switchTab('reminders',null)">
      <div class="rem-top" style="margin-bottom:0">
        <div class="rem-icon"><svg width="22" height="22" viewBox="0 0 26 26" fill="none"><defs><linearGradient id="svgBellLg" x1="0" y1="0" x2="26" y2="26" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M13 3C13 3 8 6 8 13v5H5l2 2h12l2-2h-3v-5c0-7-5-10-5-10z" fill="url(#svgBellLg)" opacity="0.85"/><circle cx="13" cy="22" r="1.5" fill="url(#svgBellLg)"/></svg></div><div class="rem-name">${S('profile','reminders')}</div>
        <div style="color:var(--sub);font-size:18px">›</div>
      </div>
    </div>
    ...
    <div class="rem-card" style="margin-top:4px">
      <div class="rem-top" style="margin-bottom:0;justify-content:space-between">
        <div style="display:flex;align-items:center;gap:10px">
          <div class="rem-icon"><svg width="22" height="22" viewBox="0 0 26 26" fill="none"><defs><linearGradient id="svgMoonLg" x1="0" y1="0" x2="26" y2="26" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#059669"/></linearGradient></defs><path d="M21 14.5A9 9 0 1111.5 5a7 7 0 009.5 9.5z" fill="url(#svgMoonLg)" opacity="0.9"/></svg></div>
          <div>
    ...
    <div class="rem-card" style="margin-top:4px">
      <div class="rem-top" style="margin-bottom:0;justify-content:space-between">
        <div style="display:flex;align-items:center;gap:10px">
          <div class="rem-icon"><svg width="22" height="22" viewBox="0 0 26 26" fill="none"><defs><linearGradient id="svgStarsLg" x1="0" y1="0" x2="26" y2="26" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#34D399"/><stop offset="100%" stop-color="#34D399"/></linearGradient></defs><circle cx="8" cy="8" r="2.2" fill="url(#svgStarsLg)"/><circle cx="18" cy="5" r="1.4" fill="url(#svgStarsLg)" opacity="0.7"/><circle cx="20" cy="16" r="1.8" fill="url(#svgStarsLg)" opacity="0.85"/><circle cx="6" cy="19" r="1.2" fill="url(#svgStarsLg)" opacity="0.6"/><circle cx="13" cy="13" r="3" fill="url(#svgStarsLg)" opacity="0.5"/></svg></div>
          <div>
    ...
    <a href="https://t.me/Super_habits" target="_blank" class="rem-card" style="margin-top:4px;display:flex;align-items:center;gap:10px;text-decoration:none;border-radius:14px 14px 0 0">
      <div class="rem-top" style="margin-bottom:0;width:100%">
        <div class="rem-icon"><svg width="22" height="22" viewBox="0 0 26 26" fill="none"><defs><linearGradient id="svgTgCh" x1="0" y1="0" x2="26" y2="26" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#059669"/><stop offset="100%" stop-color="#34D399"/></linearGradient></defs><path d="M22 4L3 11.5L10 14M22 4L15 22L10 14M22 4L10 14" stroke="url(#svgTgCh)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
        <div style="flex:1">
    ...
    <div style="border-radius:0 0 14px 14px;padding:9px 14px 10px;background:linear-gradient(90deg,#05966922,#34D39922,#05966922);box-shadow:var(--sh-sm)">
      <div style="font-size:11px;font-weight:700;font-family:'DM Sans',sans-serif;letter-spacing:0.01em;background:linear-gradient(90deg,#059669,#34D399,#10B981,#059669);background-size:300% auto;-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;animation:shimmerSlide 3s linear infinite">
        ${S('msg','channel_sub')}
      </div>
    </div>
    ...
    <div class="modal-overlay" id="lang-modal">
      <div class="modal">
        ...
        <div class="modal-title"><svg width="18" height="18" viewBox="0 0 26 26" fill="none" style="display:inline;vertical-align:middle;margin-right:6px"><defs><linearGradient id="svgGlobH" x1="0" y1="0" x2="26" y2="26" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#059669"/><stop offset="100%" stop-color="#10B981"/></linearGradient></defs><circle cx="13" cy="13" r="10" stroke="url(#svgGlobH)" stroke-width="2"/><ellipse cx="13" cy="13" rx="4.5" ry="10" stroke="url(#svgGlobH)" stroke-width="1.5"/><path d="M3 13h20M3 9h20M3 17h20" stroke="url(#svgGlobH)" stroke-width="1.2" opacity="0.5"/></svg>${S('profile','lang_modal_title')}</div>
        <div style="display:flex;flex-direction:column;gap:10px;margin-top:8px" id="lang-modal-btns"></div>
        <button class="rem-save-btn" style="margin-top:16px" onclick="saveLang()" type="button" id="lang-save-btn"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle;margin-right:5px"><defs><linearGradient id="svgSave" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#10B981"/><stop offset="100%" stop-color="#047857"/></linearGradient></defs><path d="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z" stroke="url(#svgSave)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M17 21v-8H7v8M7 3v5h8" stroke="url(#svgSave)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span id="lang-save-txt">${S('profile','save_btn')}</span></button>
      </div>
    </div>
    ...
    <div class="modal-overlay" id="edit-profile-modal">
      <div class="modal">
        ...
        <button class="save-btn" onclick="saveEditProfile()" type="button"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle;margin-right:5px"><defs><linearGradient id="svgSave" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#10B981"/><stop offset="100%" stop-color="#047857"/></linearGradient></defs><path d="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z" stroke="url(#svgSave)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M17 21v-8H7v8M7 3v5h8" stroke="url(#svgSave)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg><span id="edit-save-txt">${S('profile','save_btn')}</span></button>
      </div>
    </div>`;
  setTimeout(function() {
...
function updateDarkToggleVisual(checked) {
  ...
  if (!slider || !knob) return;
  slider.style.background = checked ? '#34D399' : 'var(--bg)';
  knob.style.background   = checked ? '#fff' : 'var(--sub)';
  knob.style.left         = checked ? '23px' : '3px';
}
