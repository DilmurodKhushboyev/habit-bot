  ...
  groups.forEach(g => {
    ...
    const membersHtml = allMembers.map((m, i) =>
      `<div class="member-row">
        <span>${i < 3 ? [`<svg width="22" height="22" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle"><defs><linearGradient id="svgRank1" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#4CAF7D"/><stop offset="100%" stop-color="#2D8A5E"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#svgRank1)"/><text x="12" y="16" text-anchor="middle" font-size="11" font-weight="700" fill="white" font-family="sans-serif">1</text></svg>`,`<svg width="22" height="22" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle"><defs><linearGradient id="svgRank2" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#7DC29A"/><stop offset="100%" stop-color="#4CAF7D"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#svgRank2)"/><text x="12" y="16" text-anchor="middle" font-size="11" font-weight="700" fill="white" font-family="sans-serif">2</text></svg>`,`<svg width="22" height="22" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle"><defs><linearGradient id="svgRank3" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#A8D9BE"/><stop offset="100%" stop-color="#7DC29A"/></linearGradient></defs><circle cx="12" cy="12" r="10" fill="url(#svgRank3)"/><text x="12" y="16" text-anchor="middle" font-size="11" font-weight="700" fill="white" font-family="sans-serif">3</text></svg>`][i] : (i+1)+'.'} ${m.name}</span>
    ...
    html += `
      <div class="rem-card" id="gcard-${g.id}" style="cursor:pointer">
        <div class="rem-top" onclick="toggleGroup('${g.id}')">
          ...
          ${g.is_admin ? `<button class="hbtn" onclick="event.stopPropagation();deleteGroup('${g.id}')" title="${S('msg','delete_btn')}"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" style="display:inline;vertical-align:middle"><defs><linearGradient id="svgTrash" x1="0" y1="0" x2="24" y2="24" gradientUnits="userSpaceOnUse"><stop offset="0%" stop-color="#E05050"/><stop offset="100%" stop-color="#B03838"/></linearGradient></defs><path d="M3 6h18M8 6V4h8v2M19 6l-1 14H6L5 6" stroke="url(#svgTrash)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M10 11v6M14 11v6" stroke="url(#svgTrash)" stroke-width="2" stroke-linecap="round"/></svg></button>` : ''}
        </div>
