...
try:
    ...
    def setup_webhook():
        ...
        try:
            ...
            # ── Bot tavsiflarini 3 tilda o'rnatish ──
            try:
                _descs = {
                    "uz": {
                        "short": "Odatlarni shakllantirish boti \U0001f331",
                        "long":  "Bu bot nimalar qila oladi?\n\n"
                                 "\U0001f4c8 Har kuni 1% ga yaxshilansangiz, yil oxirida 37 barobar kuchliroq bo\u2019lasiz.\n\n"
                                 "Maqsad natijani belgilaydi, \U0001f331 tizim (jarayon) esa unga olib boradi.\n\n"
                                 "\u2705 Odatlarni belgilash\n"
                                 "\u23f0 Vaqtida eslatma olish\n"
                                 "\U0001f525 Streak va statistika kuzatish\n"
                                 "\U0001f465 Guruh va do\u2019stlar bilan raqobat\n"
                                 "\U0001f6e1 Do\u2019kon — himoya, badge, hayvonlar"
                    },
                    "ru": {
                        "short": "\u0411\u043e\u0442 \u0434\u043b\u044f \u0444\u043e\u0440\u043c\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f \u043f\u0440\u0438\u0432\u044b\u0447\u0435\u043a \U0001f331",
                        "long":  "\u0427\u0442\u043e \u0443\u043c\u0435\u0435\u0442 \u044d\u0442\u043e\u0442 \u0431\u043e\u0442?\n\n"
                                 "\U0001f4c8 \u0423\u043b\u0443\u0447\u0448\u0430\u0439\u0442\u0435\u0441\u044c \u043d\u0430 1% \u043a\u0430\u0436\u0434\u044b\u0439 \u0434\u0435\u043d\u044c \u2014 \u0437\u0430 \u0433\u043e\u0434 \u0441\u0442\u0430\u043d\u0435\u0442\u0435 \u0432 37 \u0440\u0430\u0437 \u0441\u0438\u043b\u044c\u043d\u0435\u0435.\n\n"
                                 "\u2705 \u041e\u0442\u0441\u043b\u0435\u0436\u0438\u0432\u0430\u043d\u0438\u0435 \u043f\u0440\u0438\u0432\u044b\u0447\u0435\u043a\n"
                                 "\u23f0 \u041d\u0430\u043f\u043e\u043c\u0438\u043d\u0430\u043d\u0438\u044f\n"
                                 "\U0001f525 \u0421\u0442\u0440\u0438\u043a\u0438 \u0438 \u0441\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043a\u0430\n"
                                 "\U0001f465 \u0413\u0440\u0443\u043f\u043f\u044b \u0438 \u0441\u043e\u0440\u0435\u0432\u043d\u043e\u0432\u0430\u043d\u0438\u044f\n"
                                 "\U0001f6e1 \u041c\u0430\u0433\u0430\u0437\u0438\u043d \u2014 \u0437\u0430\u0449\u0438\u0442\u0430, \u0437\u043d\u0430\u0447\u043a\u0438, \u043f\u0438\u0442\u043e\u043c\u0446\u044b"
                    },
                    "en": {
                        "short": "Habit tracking bot \U0001f331",
                        "long":  "What can this bot do?\n\n"
                                 "\U0001f4c8 Improve 1% daily \u2014 become 37x stronger in a year.\n\n"
                                 "\u2705 Track habits\n"
                                 "\u23f0 Get reminders\n"
                                 "\U0001f525 Streaks & statistics\n"
                                 "\U0001f465 Groups & friend challenges\n"
                                 "\U0001f6e1 Shop \u2014 shields, badges, pets"
                    },
                }
                for _lc, _t in _descs.items():
                    try:
                        bot.set_my_short_description(_t["short"], language_code=_lc)
                        bot.set_my_description(_t["long"], language_code=_lc)
                    except Exception:
                        pass
                # Default (no language) — UZ
                bot.set_my_short_description(_descs["uz"]["short"])
                bot.set_my_description(_descs["uz"]["long"])
                # Tilga qarab buyruqlar
                _cmds = {
                    "uz": [BotCommand("start", "Botni ishga tushirish"), BotCommand("admin_panel", "Admin panel")],
                    "ru": [BotCommand("start", "\u0417\u0430\u043f\u0443\u0441\u0442\u0438\u0442\u044c \u0431\u043e\u0442\u0430"), BotCommand("admin_panel", "\u041f\u0430\u043d\u0435\u043b\u044c \u0430\u0434\u043c\u0438\u043d\u0430")],
                    "en": [BotCommand("start", "Start the bot"), BotCommand("admin_panel", "Admin panel")],
                }
                for _lc, _c in _cmds.items():
                    try:
                        bot.set_my_commands(_c, language_code=_lc)
                    except Exception:
                        pass
            except Exception as _desc_e:
                print(f"[setup] Bot descriptions: {_desc_e}")
