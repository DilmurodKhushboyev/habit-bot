...
def handle_text(msg):
    ...
    if state == "renaming_habit":
        ...
        kb_info.add(InlineKeyboardButton("✏️ Odat nomini o'zgartirish",     callback_data="change_habit_name"))
        kb_info.row(
    ...
    if state == "updating_name":
        ...
        kb_set.add(InlineKeyboardButton("⏰ Odatlar vaqtini tahrirlash",  callback_data="settings_habits_time"))
        kb_set.add(InlineKeyboardButton("💬 Dasturchiga habar",           callback_data="settings_contact_dev"))
