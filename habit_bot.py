    ...
    if uid:
        ...
        if groups:
            for g_info in groups:
                ...
                if is_admin2:
                    sep_row = [
                        {"text": f"👥 {g_info['name']}",             "callback_data": "noop"},
                        {"text": "➕",  "callback_data": f"group_habit_add_{g_id2}", "style": "primary"},
                        {"text": "🗑",  "callback_data": f"group_habit_del_{g_id2}", "style": "danger"},
                    ]
                else:
                    sep_row = [
                        {"text": f"👥 {g_info['name']}",             "callback_data": "noop"},
                        {"text": "🔗",  "callback_data": f"group_invite_{g_id2}",   "style": "primary"},
                        {"text": "🚪",  "callback_data": f"group_leave_{g_id2}",    "style": "danger"},
                    ]
                rows.append(sep_row)
                # Har bir guruh odati
                for h in g_habits:
