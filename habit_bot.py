...
def cmd_start(msg):
    ...
    # Barcha oldingi /start xabarlarini o'chirish
    ...
    # /start buyrug'ining o'zini ham o'chirish uchun qo'shamiz
    # (msg.message_id hali ma'lum emas, lekin biroz oldingi ID lar ham o'chirilsin)
    # Ro'yxatni tozalaymiz — keyingi /start uchun qayta boshlaymiz
    u_prev["start_msg_ids"] = []
    save_user(uid, u_prev)
    def delete_old_starts(chat_id, ids, cmd_id):
        # /start buyrug'ining o'zini ham o'chirish
        all_ids = ids + [cmd_id]
        for mid in all_ids:
