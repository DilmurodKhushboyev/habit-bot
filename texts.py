...
LANGS = {
    "uz": {
        ...
        "err_server_busy":   "⏳ Server band — birozdan keyin qayta urinib ko'ring.",
    ...
    "en": {
        ...
        "err_server_busy":   "⏳ Server busy — please try again in a moment.",
    ...
    "ru": {
        ...
        "err_server_busy":   "⏳ Сервер занят — попробуйте ещё раз через мгновение.",
